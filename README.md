...
- [微信小程序图片裁剪工具we-cropper](https://we-plugin.github.io/we-cropper/#/)
- [微信小程序：上传头像或图片使用we-cropper裁剪后并上传自己服务器](https://segmentfault.com/a/1190000042072077)
- [【已解决】微信小程序消除/去掉/隐藏左上角返回按钮](https://blog.csdn.net/FFqiufeng/article/details/122430613)
